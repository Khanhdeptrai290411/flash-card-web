        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4"> 
                ...
                <select name="role" id="role" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
                    <option value="student" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">Student</option>
                    <option value="teacher" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">Teacher</option>
                </select>
            </div>
